...
-- Were there any missing values in the data, using which tool did you replace them and what are the ways to
-- handle them?
select 
...
SELECT CustomerID, EstimatedSalary,Bank_doj as Date, quarter(Bank_doj) as Quarter FROM customerinfo
